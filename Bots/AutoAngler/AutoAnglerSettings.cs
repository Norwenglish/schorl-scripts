...
namespace HighVoltz
{
    public class AutoAnglerSettings : Settings
    {
        ...
        [Setting, Styx.Helpers.DefaultValue(0u),
         Description("Wowhead Id of the offhand weapon to switch to when in combat"),
         Category("Weapon")]
        ...
        [Setting, Styx.Helpers.DefaultValue(true),
         Description("Set to true to enable flying,false to use ground based navigation")
        , Category("Fishing")]
        public bool Fly { get; set; }

        [Setting, Styx.Helpers.DefaultValue(true),
         Description("If set to true bot will use water walking, either use class abilities or pots")
        , Category("Fishing")]
        ...
        [Setting, Styx.Helpers.DefaultValue(5),
         Description("The maximum time in minutes to spend at a pool before it gets blacklisted")
        , Category("Advanced")]
        public int MaxTimeAtPool { get; set; }

        [Setting, Styx.Helpers.DefaultValue(15),
         Description("The maximum number of failed casts at a pool before moving to a new location at pool")
        , Category("Advanced")]
        ...
        [Setting, Styx.Helpers.DefaultValue(10),
         Description("Min range to stand at a pool, between 10 and 14 recomended")
        , Category("Advanced")]
        public int MinPoolRange { get; set; }

        [Setting, Styx.Helpers.DefaultValue(20),
         Description(
             "Max range to stand at a pool, 22 is maximum you should go. Recommended range is 18-22 (20 is probably best)"
             )
        , Category("Advanced")]
