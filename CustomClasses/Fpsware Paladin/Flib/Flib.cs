...
namespace Hera
{
    ...
    public static class Target
    {
        ...
        /// </summary>
        public static bool IsLowLevel { get { if (!Me.GotTarget) return false;  if (CT.Level < 6) return false; return CT.Level <= Me.Level - 4; } }
        ...
        {
            return Me.GotTarget && Spell.CanCast(spellName) && (!CT.HasAura(spellName) || CT.Auras[spellName].CreatorGuid != Me.Guid) && CT.Distance <= Spell.MaxDistance(spellName);
        }
