        ...
        public static class Hunter
        {
            ...
            public static class Pet
            {
                ...
                public static bool DefendMe()
                {
                    ...
                    {
                        Utils.Log(String.Format("Aggro from {0}, pet save my ass!", thing.Name), Color.FromName("Green"));
        ...
        public static class Rogue
        {
            ...
            public static class Poisons
            {
                ...
                public static void ApplyPoisons()
                {
                    ...
                    {
                        Debug.Assert(mainPoison != null, "mainPoison != null");
                    ...
                    {
                        Debug.Assert(offPoison != null, "offPoison != null");
...
*/
        ...
        public static class Common
        {
            ...
            public static WoWUnit DecursePlayer(List<WoWDispelType> canCureList, bool includePartyMembers)
            {
                ...
                if (Me.IsInParty || Me.IsInRaid)
                {
                    ...
                    var player = (from p in myPartyOrRaidGroup from aura in p.Auras where aura.Value.IsHarmful from dispelType in canCureList where dispelType == aura.Value.Spell.DispelType select p).FirstOrDefault();
        ...
        public static class Mage
        {
            ...
            {
                return ObjectManager.GetObjectsOfType<WoWUnit>().Where(unit => unit.Auras.ContainsKey("Polymorph")).Any(unit => unit.Location.Distance(location) <= distance);
            }
...
*/
            ...
            public static class IDs
            {
                ...
                public static int FelArmor = 28176;                 // ALL
                ...
                public static List<int> ImprovedSoulFire = new List<int> {85385, 85383};
                public static int ShadowTrance = 17941;
                public static int SoulburnSearingPain = 79440;
                public static int EmpoweredImp = 47283;             // Active auras
