...
namespace UltimatePaladinHealerBT
{
    ...
    new PrioritySelector(
        ...
        {
            return (
                new Decorator(ret => _wanna_SWD && SpellManager.HasSpell("Shadow Word: Death") && !SpellManager.Spells["Shadow Word: Death"].Cooldown && Me.Combat && unitcheck(Enemy) && Enemy.Distance < 40 && Enemy.InLineOfSight && Enemy.HealthPercent < 25 && Me.HealthPercent>25,
                    new PrioritySelector(
        ...
        public Composite Composite_Priest_Solo_Combat()
        {
            return (
                new Decorator(ret => unitcheck(Enemy),
                    new PrioritySelector(
                                 new Decorator(ret => SpellManager.HasSpell("Holy Word: Chastise") && !SpellManager.Spells["Holy Word: Chastise"].Cooldown && Enemy.Distance < 30 && Enemy.InLineOfSight && Me.HasAura("Chakra: Chastise"),
              new Wait(2, ret => !IsCastingOrGCD(),
                  new Action(
                        delegate
                        {
         ...
         new Decorator(ret => SpellManager.HasSpell("Holy Fire") && !SpellManager.Spells["Holy Fire"].Cooldown && Enemy.Distance < 30 && Enemy.InLineOfSight,
              new Wait(2, ret => !IsCastingOrGCD(),
                  new Action(
                        delegate
                        {
         ...
         new Decorator(ret=> !Me.HasAura("Chakra: Chastise") && SpellManager.HasSpell("Chakra") && !SpellManager.Spells["Chakra"].Cooldown,
             new PrioritySelector(
                        ...
                        new Decorator(ret => Me.Combat && tar.HealthPercent < _min_ohshitbutton_activator,
                            new PrioritySelector(
                                new Action(
                                    ...
                                    new Decorator(ret=>Should_AOE(Me, "Divine Hymm",_min_player_inside_DY, 30,_DY_how_much_health) && !Me.IsMoving,
                                        new Wait(2,ret=> !IsCastingOrGCD(), 
                                            new Action(delegate
                            {
            ...
            return (
                new Decorator(ret => !GotBuff("Guardian Spirit", tar) && !GotBuff("Lifeblood"),
                    new PrioritySelector(
                        ...
                        new Decorator(ret => _wanna_GS && SpellManager.HasSpell("Guardian Spirit") && !SpellManager.Spells["Guardian Spirit"].Cooldown && unitcheck(tar) && unitcheck(tank) && tank==tar,
                            new Wait(2, ret => !IsCastingOrGCD(), 
                                new Action(delegate
                            {
        ...
        public Composite Composite_Priest_Ensure_Chakra()
        {
            return(
                ...
                new PrioritySelector(
                new Decorator(ret => SpellManager.HasSpell("Chakra") && !SpellManager.Spells["Chakra"].Cooldown && !Me.HasAura("Chakra") && !Me.HasAura("Chakra: Serenity") && !Me.HasAura("Chakra: Sanctuary") && !Me.HasAura("Chakra: Chastise"),
                    new Wait(2,ret=> !IsCastingOrGCD(), 
                        new Action(
                            delegate{
        ...
        public Composite Composite_Priest_Healing_check_and_buff()
        {
            return (
                new PrioritySelector(
                        ...
                        new Decorator(ret => !Me.HasAura("Inner Fire") && !Me.Mounted && SpellManager.HasSpell("Inner Fire"),
                            new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                                {
        ...
        public Composite Composite_Spirit_of_Redemption_Healing()
        {
            ...
            new Decorator(ret => SpellManager.HasSpell("Renew") && !GotBuff("Renew", tar),
                new Wait(2,ret=> !IsCastingOrGCD(), 
                                            new Action(delegate
                                            {
                                            ...
                                            new Decorator(ret => SpellManager.HasSpell("Flash Heal") && GotBuff("Surge of Light"),
                new Wait(2,ret=> !IsCastingOrGCD(), 
                                            new Action(delegate
                                            {
                                                ...
                                                { return RunStatus.Success; }
                                                 ...
                                                 new Decorator(ret => Should_AOE("Circle of Healing", _min_player_inside_CoH, 30, _CoH_how_much_health,out x),
                ...
                new Wait(2,ret=> !IsCastingOrGCD(), 
                                            ...
                                            new Decorator(ret => SpellManager.HasSpell("Flash Heal") && GetAuraStackCount(Me, "Serendipity") < 2,
                new Wait(2,ret=> !IsCastingOrGCD(), 
                                            new Action(delegate
                                            {
                                            ...
                                            new Decorator(ret => SpellManager.HasSpell("Greater Heal") && GetAuraStackCount(Me, "Serendipity") == 2,
                new Wait(2,ret=> !IsCastingOrGCD(), 
                                            new Action(delegate
                                            {
...
new Decorator(ret => SpellManager.HasSpell("Renew") && !GotBuff("Renew", tar) && tar == tank,
    new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                                {
                                    if (Cast("Renew", tar, 40, "Heal", "Healing"))
                                ...
                                new Decorator(ret => _use_PoM_on_CD && _wanna_PoM && unitcheck(tank) && SpellManager.HasSpell("Prayer of Mending") && !SpellManager.Spells["Prayer of Mending"].Cooldown && !GotBuff("Prayer of Mending", tank) && !Me.Mounted && tank != Me && tank.Distance < _max_healing_distance && tank.InLineOfSight,
        new Wait(2,ret=> !IsCastingOrGCD(), 
                    new Action(delegate
                    {
                    ...
                    new Decorator(ret => !_use_PoM_on_CD && _wanna_PoM, Composite_Prayer_of_Mending()),
                                ...
                                new Decorator(ret => SpellManager.HasSpell("Renew") && !GotBuff("Renew", tar) && tar.HealthPercent < _min_renew_hp_on_non_tank,
    new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                                {
                                    if (Cast("Renew", tar, 40, "Heal", "Healing"))
    ...
    new Wait(2,ret=> !IsCastingOrGCD(), 
        ...
        new PrioritySelector(
                                ...
                                new Decorator(ret => SpellManager.HasSpell("Binding Heal") && !Me.IsMoving && Me.HealthPercent < _binding_heal_min_hp && tar.HealthPercent < _binding_heal_min_hp && Me != tar,
    new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                                {
                                ...
                                new Decorator(ret => SpellManager.HasSpell("Binding Heal") && !Me.IsMoving && tar == Me && tank!=Me && Me.HealthPercent < _binding_heal_min_hp && tank.HealthPercent < _Heal_min_hp,
    new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                                {
                                ...
                                new Decorator(ret => SpellManager.HasSpell("Binding Heal") && tar == Me && !Me.IsMoving && Me.HealthPercent < _binding_heal_min_hp && tank.HealthPercent > _Heal_min_hp,
                                    new PrioritySelector(
                                    new Action(
                                        delegate
                                        {
                                        ...
                                        new Decorator(ret => unitcheck(x) && x.HealthPercent < _binding_heal_min_hp && x!=Me,
                                            new Wait(2,ret=> !IsCastingOrGCD(), 
                                            new Action(
                                                delegate
                                                {
                                ...
                                new Decorator(ret => SpellManager.HasSpell("Flash Heal") && GotBuff("Surge of Light") && tar.HealthPercent < _SoL_min_hp,
    new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                                {
                                    if (Cast("Flash Heal", tar, 40, "Healing", "Got Surge of Light!"))
                                ...
                                new Decorator(ret => SpellManager.HasSpell("Flash Heal") && !Me.IsMoving && GetAuraStackCount(Me, "Serendipity") < 2 && tar.HealthPercent < _Serendipity_min_hp,
    new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                                {
                                    if (Cast("Flash Heal", tar, 40, "Buff", "Need Serendipity Buff"))
                                ...
                                new Decorator(ret => SpellManager.HasSpell("Greater Heal") && !Me.IsMoving && GetAuraStackCount(Me, "Serendipity") == 2 && tar.HealthPercent < _Serendipity_GH_min_hp,
    new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                                {
                                    if (Cast("Greater Heal", tar, 40, "Heal", "Healing with Serendipity"))
                                    { return RunStatus.Success; }
                                     ...
                                     new Decorator(ret => SpellManager.HasSpell("Greater Heal") && !Me.IsMoving && tar.HealthPercent < _GH_min_hp,
    new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                                {
                                ...
                                new Decorator(ret => SpellManager.HasSpell("Heal") && !Me.IsMoving && tar.HealthPercent < _Heal_min_hp,
    new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                                {
        ...
        public Composite Composite_Priest_Actual_AOE_Healing()
        {
            ...
            new Decorator(ret => SpellManager.HasSpell("Renew") && !GotBuff("Renew", tar) && tar == tank,
                new Wait(2,ret=> !IsCastingOrGCD(), 
                                            ...
                                            new Decorator(ret=> _use_PoM_on_CD && unitcheck(tank) && SpellManager.HasSpell("Prayer of Mending") && !SpellManager.Spells["Prayer of Mending"].Cooldown && !GotBuff("Prayer of Mending", tank) && !Me.Mounted && tank != Me && tank.Distance < _max_healing_distance && tank.InLineOfSight,
                    new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                                {
                                    if (Cast("Prayer of Mending", tank, 40, "Buff", "Missing Prayer of Mending"))
                ...
                new Wait(2,ret=> !IsCastingOrGCD(), 
                                            ...
                                            new Decorator(ret => SpellManager.HasSpell("Binding Heal") && !Me.IsMoving && tar == Me && Me.HealthPercent < _binding_heal_min_hp && tank.HealthPercent < _Heal_min_hp,
                new Wait(2,ret=> !IsCastingOrGCD(), 
                                            new Action(delegate
                                            {
                                                if (Cast("Binding Heal", tank, 40, "Heal", "Healing"))
                                            ...
                                            new Decorator(ret => SpellManager.HasSpell("Binding Heal") && tar == Me && !Me.IsMoving && Me.HealthPercent < _binding_heal_min_hp && tank.HealthPercent > _Heal_min_hp,
                                                ...
                                                new Action(
                                                    ...
                                                    new Decorator(ret => unitcheck(x) && x.HealthPercent < _binding_heal_min_hp,
                                                        new Wait(2,ret=> !IsCastingOrGCD(), 
                                                        new Action(
                                                            delegate
                                                            {
...
new Decorator(ret => unitcheck(CleanseTarget),
    new Wait(2,ret=> !IsCastingOrGCD(), 
            ...
            return (
                ...
                new Decorator(ret => unitcheck(tar),
                    new PrioritySelector(
                        ...
                        new Decorator(ret => !(Me.IsMoving) && tar.HealthPercent > _Heal_min_hp && tar.HealthPercent < _do_not_heal_above && !(tank != null && tank.IsValid && (Me.Mounted && !Me.Combat && !tank.Combat) || ((!Me.Combat && !tar.Combat && tar.Distance > 40))),
                            new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                                {
        ...
        {
            return (
                new Decorator(ret => SpellManager.HasSpell("Prayer of Healing") && !Me.Mounted,
                    new PrioritySelector(
                /*new Decorator(ret => _AOE_check_everyone,
        ...
        {
            return (
                new Decorator(ret => unitcheck(tank) && SpellManager.HasSpell("Prayer of Mending") && !SpellManager.Spells["Prayer of Mending"].Cooldown && !GotBuff("Prayer of Mending", tank) && !Me.Mounted && tank != Me && tank.Distance < _max_healing_distance && tank.InLineOfSight,
                    new PrioritySelector(
                        new Action(
                            delegate{
        ...
        {
            return(
                new Decorator(ret => unitcheck(tank) && SpellManager.HasSpell("Prayer of Mending") && !SpellManager.Spells["Prayer of Mending"].Cooldown && !GotBuff("Prayer of Mending", tank) && !Me.Mounted && tank != Me &&tank.Distance<_max_healing_distance && tank.InLineOfSight && TankGotTarget(),
                    new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                                {
                                    if (Cast("Prayer of Mending", tank, 40, "Buff", "Missing Prayer of Mending"))
            ...
            return (
                new PrioritySelector(
                    new Decorator(ret => sw.Elapsed.TotalSeconds > _use_mana_rec_trinket_every && Me.Combat && Me.ManaPercent <= _min_mana_rec_trinket,
                        ...
                        new Decorator(ret => _wanna_DP && Me.HealthPercent < _min_DP_hp && Me.Combat && SpellManager.HasSpell("Desperate Prayer") && !SpellManager.Spells["Desperate Prayer"].Cooldown,
                            new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                                {
                        ...
                        new Decorator(ret => _wanna_fade && Me.HealthPercent < _min_fade_hp && Me.Combat && SpellManager.HasSpell("Fade") && !SpellManager.Spells["Fade"].Cooldown && IsEnemyAttakingMe(),
                            new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                                {
                                ...
                                new Decorator(ret => Me.Combat && unitcheck(Enemy) && Me.ManaPercent <= _min_Shadowfiend_mana_NOT_safe && Me.Combat && SpellManager.HasSpell("Shadowfiend") && !SpellManager.Spells["Shadowfiend"].Cooldown,
                        new Wait(2,ret=> !IsCastingOrGCD(), 
                            new Action(delegate
                            {
        ...
        public Composite Composite_Priest_Mana_Rec()
        {
            return (
                new PrioritySelector(
                    new Decorator(ret => Me.Combat && unitcheck(Enemy) && Me.ManaPercent <= _min_Shadowfiend_mana_if_safe && Me.Combat && SpellManager.HasSpell("Shadowfiend") && !SpellManager.Spells["Shadowfiend"].Cooldown&& ((_check_level_for_shadowfind && Enemy.Level>Me.Level+2) || !_check_level_for_shadowfind),
                        new Wait(2,ret=> !IsCastingOrGCD(), 
                            new Action(delegate
                            {
                                if (Me.CurrentTarget != Enemy) { Enemy.Target(); }
                ...
                new Decorator(ret=> _wanna_Hymm_of_Hope_after_shadowfiend&& Me.Combat && unitcheck(Enemy) && Me.Combat && SpellManager.HasSpell("Hymm of Hope") && !SpellManager.Spells["Hymm of Hope"].Cooldown,
                    new Wait(2,ret=> !IsCastingOrGCD(), 
                            new Action(delegate
                            {
        ...
        public Composite Composite_Priest_Raid()
        {
            ...
            Composite_inizialize_subgroup(),
                    new Decorator(ret => Global_chimaeron || _selective_healing,
                        ...
                        new Decorator(ret=>!Global_chimaeron && !_selective_healing && _raid_healer,
            ...
            return (
                new PrioritySelector(
                    new Decorator(ret => Global_chimaeron,
                        //Composite_Chimearon()
                        new Action(delegate{slog("Chimaeron fight not yet supported for priest, CC is DISABLED!");})
                        ),
            new Decorator(ret => _selective_healing,
                Composite_Priest_Raid_Selective_healing())
                )
                 );
        }
