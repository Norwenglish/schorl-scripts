       ...
       //     Solo_TantfocusTT.SetToolTip(this.Solotankfromfocus, "If enabled will set your Focus as the CC tank");
        ...
        private void save_Click_1(object sender, System.EventArgs e)
        {
            ...
            if (dr == DialogResult.Yes)
            {
                ...
                UltimatePalaHealerBT.Instance._combatBehavior = UltimatePalaHealerBT.Instance.Composite_Selector();
                //Variable_inizializer();
                UltimatePalaHealerBT.Instance._restBehavior = UltimatePalaHealerBT.Instance.Composite_Rest_Selector();
                UltimatePalaHealerBT.Instance.Variable_Printer();
                
                if (UPaHBTSetting.Instance.IsConfigured == false)
                {
                    Logging.Write(Color.Red,
                    ...
                    UPaHBTSetting.Instance.IsConfigured = true;
