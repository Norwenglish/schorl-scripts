...
namespace UltimatePaladinHealerBT
{
    public partial class UltimatePalaHealerBT
    {
        ...
        public Composite Composite_Raid()
        {
            return (
                new PrioritySelector(
                    ...
                    new Decorator(ret => Global_chimaeron || _selective_healing,
        ...
        {
            return (
                new Decorator(ret => unitcheck(Epet) && unitcheck(Epet.CurrentTarget) && Epet.CurrentTarget != Me && unitcheck(tank) && (!Me.Mounted || !tank.Mounted) && (Me.Combat || tank.Combat) && !Me.IsCasting && SpellManager.HasSpell("Righteous Defense") && !SpellManager.Spells["Righteous Defense"].Cooldown,
                    new Wait(2,ret=> !IsCastingOrGCD(),  new Action(
                        delegate
                        {
    ...
    new Action(delegate
    {
        ...
        public Composite Composite_Solo_Combat()
        {
         ...
         new Decorator(ret => SpellManager.HasSpell("Holy Shock") && !SpellManager.Spells["Holy Shock"].Cooldown && Enemy.Distance < 20 && Enemy.InLineOfSight,
              new Wait(2,ret=> !IsCastingOrGCD(), 
                  new Action(
                        delegate
                        {
        ...
        public Composite Composite_Solo_Buff()
        {
            return (
                new PrioritySelector(
                    ...
                    Composite_Aura(),
                //Composite_Beacon(),
                    //Composite_Solo_Blessing()
                    Composite_Blessing()
                    ));
        }
        /*
        public Composite Composite_Solo_Blessing()
        {
            return (
                new Decorator(ret => !GotBuff("Blessing of Kings", Me) && !Me.Mounted,
                    new Action(
                        delegate
                        {
                            if (Cast("Blessing of Kings", "Buff", "Missing Blessing"))
                            { return RunStatus.Success; }
                            else { return RunStatus.Failure; }
                        }
         )));
        ...
        public Composite Composite_PVPRacials()
        {
            return (
                new PrioritySelector(
                    Composite_Racials(),
                    new Decorator(ret => _wanna_torrent && unitcheck(Enemy) && Enemy.Distance < 10 && Enemy.IsCasting && SpellManager.Spells["Rebuke"].Cooldown,
                        new Wait(2,ret=> !IsCastingOrGCD(), 
                            new Action(
             delegate
             {
        ...
        public Composite Composite_Racials()
        {
            return (
                new PrioritySelector(
                    new Decorator(ret => _wanna_stoneform && SpellManager.HasSpell("Stoneform") && !SpellManager.Spells["Stoneform"].Cooldown && Me.HealthPercent < _min_stoneform && !GotBuff("Divine Protection"),
                        new Wait(2,ret=> !IsCastingOrGCD(), 
                            new Action(
                 delegate
                 {
         ...
         new Decorator(ret => _wanna_everymanforhimself && SpellManager.HasSpell("Every Man for Himself") && !SpellManager.Spells["Every Man for Himself"].Cooldown && Me.Stunned && !GotBuff("Charge Stun") && !GotBuff("Sap"),
             new Wait(2,ret=> !IsCastingOrGCD(), 
                 new Action(
                 delegate
                 {
         ...
         new Decorator(ret => _wanna_gift && SpellManager.HasSpell("Gift of the Naaru") && !SpellManager.Spells["Gift of the Naaru"].Cooldown && unitcheck(tar) && tar.HealthPercent < _min_gift_hp,
                new Wait(2,ret=> !IsCastingOrGCD(), 
                    new Action(
             delegate
             {
        ...
        public Composite Composite_PVERacials()
        {
            return (
                new PrioritySelector(
                    Composite_Racials(),
         new Decorator(ret => _wanna_torrent && SpellManager.HasSpell("Arcane Torrent") && !SpellManager.Spells["Arcane Torrent"].Cooldown && Me.ManaPercent < _min_torrent_mana_perc,
             new Wait(2,ret=> !IsCastingOrGCD(), 
                 new Action(
             delegate
             {
        ...
        public Composite Composite_EnemyInterrupt()
        {
            return (
                ...
                new PrioritySelector(
                    new Decorator(ret => _wanna_rebuke && SpellManager.HasSpell("Rebuke") && !SpellManager.Spells["Rebuke"].Cooldown && Enemy.IsWithinMeleeRange && Enemy.InLineOfSight,
                        new Wait(2,ret=> !IsCastingOrGCD(), 
                            new Action(
                 delegate
                 {
         ...
         new Decorator(ret => _wanna_HoJ && Enemy.HealthPercent < 50,
            ...
            new Decorator(ret => SpellManager.HasSpell("Hammer of Justice") && !SpellManager.Spells["Hammer of Justice"].Cooldown && Enemy.Distance < 10 && Enemy.InLineOfSight,
            new Wait(2,ret=> !IsCastingOrGCD(), 
                new Action(
                 delegate
                 {
        ...
        public Composite Composite_ConsumeTime()
        {
            ...
            new Decorator(ret => SpellManager.HasSpell("Crusader Strike") && !SpellManager.Spells["Crusader Strike"].Cooldown && Enemy.IsWithinMeleeRange && Enemy.InLineOfSight,
            new Wait(2,ret=> !IsCastingOrGCD(), 
                new Action(
                 delegate
                 {
        ...
        {
            return (
                new Decorator(ret => _wanna_HoW && SpellManager.HasSpell("Hammer of Wrath") && !SpellManager.Spells["Hammer of Wrath"].Cooldown && Me.Combat && unitcheck(Enemy) && Enemy.Distance<30 && Enemy.InLineOfSight && Enemy.HealthPercent<20,
                    new PrioritySelector(
                        new Decorator(ret => _wanna_face,
                            new Action(
                                delegate
        ...
        {
            return (
                new Decorator(ret => SpellManager.HasSpell("Hand of Freedom") && !SpellManager.Spells["Hand of Freedom"].Cooldown,
 new PrioritySelector(
     new Action(
         delegate
         {
 ...
 new Wait(2,ret=> !IsCastingOrGCD(), 
     ...
     delegate
     {
        ...
        public Composite Composite_Seal()
        {
            return (
                new PrioritySelector(
                new Decorator(ret => !GotBuff("Seal of Insight") && (!Me.Mounted) && SpellManager.HasSpell("Seal of Insight"),
                        new Wait(2,ret=> !IsCastingOrGCD(), 
                            new Action(delegate
                        {
                        ...
                        new Decorator(ret=>!SpellManager.HasSpell("Seal of Insight") && !GotBuff("Seal of Righteousness") && SpellManager.HasSpell("Seal of Righteousness") &&(!Me.Mounted),
                            new Wait(2,ret=> !IsCastingOrGCD(), 
                            new Action(delegate
                        {
        ...
        public Composite Composite_Aura()
        {
            return (
                new PrioritySelector(
                        new Decorator(ret => _aura_type == 0 && !IsPaladinAura("Concentration Aura") && (!_wanna_crusader || _wanna_crusader && !Me.Mounted),
                            new Action(delegate
                            {
                        ...
                        new Decorator(ret => _aura_type == 1 && !IsPaladinAura("Resistance Aura") && (!_wanna_crusader || _wanna_crusader && !Me.Mounted),
                            new Action(delegate
                            {
        ...
        {
            return (
                new Decorator(ret => unitcheck(tank) && BeaconNeedsRefresh(tank) && tank.Distance<40 && SpellManager.HasSpell("Beacon of Light") && tank.InLineOfSight && !Me.Mounted && !_ignore_beacon,
                        new Wait(2,ret=> !IsCastingOrGCD(), 
                            new Action(delegate
                        {
        ...
        public Composite Composite_Blessing()
        {
            return (
                new PrioritySelector(
                    ...
                    new Decorator(ret => unitcheck(BlessTarget) && ( /*(GotBuff("Mark of the Wild", BlessTarget) || GotBuff("Blessing of Kings", BlessTarget)) &&*/ !GotBuff("Blessing of Might", BlessTarget) && !_should_king && (!Me.Mounted)),
                        new Action(delegate
                        {
                            ...
                            { return RunStatus.Success; }
                               ...
                               new Decorator(ret => unitcheck(BlessTarget) && (!GotBuff("Blessing of Kings", BlessTarget) && !GotBuff("Mark of the Wild", BlessTarget) && _should_king && (!Me.Mounted)),
                                   new Action(delegate
                                   {
            ...
            return (
                new Decorator(ret => unitcheck(tar),
                    new PrioritySelector(
                        ...
                        new Decorator(ret => !(Me.IsMoving) && tar.HealthPercent > _min_HL_hp && tar.HealthPercent < dontHealAbove && !(tank != null && tank.IsValid && (Me.Mounted && !Me.Combat && !tank.Combat) || ((!Me.Combat && !tar.Combat && tar.Distance > 40))),
                            new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                            {
        ...
        public Composite Composite_Judgeformana()
        {
            ...
            return (
                new Decorator(ret => SpellManager.HasSpell("Judgement") && !SpellManager.Spells["Judgement"].Cooldown,
                new Wait(2,ret=> !IsCastingOrGCD(), 
                    new Action(delegate
                {
        ...
        public Composite Composite_Mana_Rec()
        {
            return (
                new PrioritySelector(
                    ...
                    new Decorator(ret => Me.ManaPercent <= _min_Divine_Plea_mana && Me.Combat && SpellManager.HasSpell("Divine Plea") && !SpellManager.Spells["Divine Plea"].Cooldown,
                        new Wait(2,ret=> !IsCastingOrGCD(), 
                            new Action(delegate
                        {
        ...
        public Composite Composite_Healing_check_and_buff()
        {
            return (
                new PrioritySelector(
                        ...
                        Composite_Beacon(),
                        new Decorator(ret => SealNeedRefresh() && !Me.Mounted && SpellManager.HasSpell("Seal of Insight"),
                            new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                            {
                                if (Cast("Seal of Insight", "Buff", "Missing Seal"))
                            ...
                            new Decorator(ret => SealNeedRefresh() && !Me.Mounted && !SpellManager.HasSpell("Seal of Insight") && SpellManager.HasSpell("Seal of Righteousness"),
                            new Wait(2, ret => !IsCastingOrGCD(), 
                                new Action(delegate
                                {
                                    if (Cast("Seal of Righteousness", "Buff", "Missing Seal"))
        ...
        new PrioritySelector(
            ...
            new Decorator(ret => _wanna_LoH && tar.HealthPercent < _min_LoH_hp && !tar.ActiveAuras.ContainsKey("Forbearance") && SpellManager.HasSpell("Lay on Hands") && !SpellManager.Spells["Lay on Hands"].Cooldown && tar.Distance<40 && tar.InLineOfSight &&(Me.Combat || tar.Combat),
                new Wait(2,ret=> !IsCastingOrGCD(), 
                    new Action(delegate
                {
            ...
            new Decorator(ret => _wanna_HoP && tar.HealthPercent < _min_HoP_hp && tar.Guid != tank.Guid && !IsTank(tar) && !tar.ActiveAuras.ContainsKey("Forbearance") && SpellManager.HasSpell("Hand of Protection") && !SpellManager.Spells["Hand of Protection"].Cooldown && tar.Distance < 30 && tar.InLineOfSight && (Me.Combat || tar.Combat) && !tar.HasAura("Alliance Flag") && !tar.HasAura("Horde Flag"),
                new Wait(2,ret=> !IsCastingOrGCD(), 
                    new Action(delegate
                {
            ...
            new Decorator(ret => _wanna_HoS && tar.HealthPercent < _min_HoS_hp && tar.Guid == tank.Guid && SpellManager.HasSpell("Hand of Sacrifice") && !SpellManager.Spells["Hand of Sacrifice"].Cooldown && tar.Distance < 30 && tar.InLineOfSight && Me.HealthPercent > 90 && (Me.Combat || tar.Combat),
                new Wait(2,ret=> !IsCastingOrGCD(), 
                    new Action(delegate
                {
        ...
        public Composite Composite_Emergency_button()
        {
            return (
                    new PrioritySelector(
                        ...
                        new Decorator(ret => _wanna_HoP && tar.HealthPercent < _min_HoP_hp && tar.Guid != tank.Guid && !IsTank(tar) && !tar.ActiveAuras.ContainsKey("Forbearance") && SpellManager.HasSpell("Hand of Protection") && !SpellManager.Spells["Hand of Protection"].Cooldown && tar.Distance < 30 && tar.InLineOfSight && (Me.Combat || tar.Combat),
                            new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                            {
                                if (Cast("Hand of Protection", tar, 30, "Heal", "Saving someone life"))
                ...
                new PrioritySelector(
                    new Action(delegate{
                        ...
                        new Decorator(ret => Me.CurrentHolyPower == 3,
                            new PrioritySelector(
                                new Decorator(ret => SpellManager.HasSpell("Light of Dawn") && HolyPowerDump(),
                                    new Wait(2,ret=> !IsCastingOrGCD(), 
                                        new Action(delegate
                                    {
                                ...
                                new Decorator(ret => SpellManager.HasSpell("Word of Glory"),
                                    new Wait(2,ret=> !IsCastingOrGCD(), 
                                        new Action(delegate
                                    {
                        ...
                        new Decorator(ret => SpellManager.HasSpell("Holy Shock") && !SpellManager.Spells["Holy Shock"].Cooldown,//CanCast("Holy Shock", tar) /*&& !SpellManager.Spells["Holy Shock"].Cooldown*/,
                            new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                            {
                        ...
                        new Decorator(ret => _wanna_HR && SpellManager.HasSpell("Holy Radiance") && Should_AOE(Me, "Holy Radiance", _min_player_inside_HR, _HR_how_far, _HR_how_much_health),
                            new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                            {
                            ...
                            new Action(delegate
            {
                slog("This is the last check before the real Heal, was a global cooldown proble? now we will know! will try to heal tar {0} at hp {1} and distance {2} me.ismoving {3} cancastDL {4} cancastFL {5} cancastHL {6} Global cooldown {7} left {8}", privacyname(tar), Round(tar.HealthPercent), Round(tar.Distance), Me.IsMoving, CanCast("Divine Light", tar), CanCast("Flash of Light", tar), CanCast("Holy Light", tar),SpellManager.GlobalCooldown,SpellManager.GlobalCooldownLeft);
                return RunStatus.Failure;
            }
            ),*/
                        new Decorator(ret => _Inf_of_light_wanna_DL && GotBuff("Infusion of Light") && tar.HealthPercent < _min_Inf_of_light_DL_hp && !(Me.IsMoving),
                            new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                            {
                        ...
                        new Decorator(ret => !_Inf_of_light_wanna_DL && GotBuff("Infusion of Light") && !(Me.IsMoving),
                            new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                            {
                        ...
                        new Decorator(ret => tar.HealthPercent < _min_FoL_hp && SpellManager.HasSpell("Flash of Light") && tar.Distance<40 && tar.InLineOfSight && !(Me.IsMoving),
                            new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                            {
                                if (Cast("Flash of Light", tar, 40, "Heal", "Healing"))
                        ...
                        new Decorator(ret => tar.HealthPercent < _min_DL_hp && SpellManager.HasSpell("Divine Light") && tar.Distance < 40 && tar.InLineOfSight && !(Me.IsMoving),
                            new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                            {
                                if (Cast("Divine Light", tar, 40, "Heal", "Healing"))
                        ...
                        new Decorator(ret => tar.HealthPercent < _min_HL_hp && SpellManager.HasSpell("Holy Light") && tar.Distance < 40 && tar.InLineOfSight && !(Me.IsMoving),
                            new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                            {
                                if (Cast("Holy Light", tar, 40, "Heal", "Healing"))
            ...
            return (
                new Decorator(ret => !GotBuff("Divine Favor") && !GotBuff("Avenging Wrath") && !GotBuff("Guardian of Ancient Kings") && !GotBuff("Lifeblood"),
                    new PrioritySelector(
                        ...
                        new Decorator(ret => _wanna_lifeblood && SpellManager.HasSpell("Lifeblood") && !SpellManager.Spells["Lifeblood"].Cooldown,
                            new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                            {
                        ...
                        new Decorator(ret => _wanna_AW && SpellManager.HasSpell("Avenging Wrath") && !SpellManager.Spells["Avenging Wrath"].Cooldown,
                            new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                            {
                        ...
                        new Decorator(ret => _wanna_DF && SpellManager.HasSpell("Divine Favor") && !SpellManager.Spells["Divine Favor"].Cooldown,
                            new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                            {
                        ...
                        new Decorator(ret => _wanna_GotAK && SpellManager.HasSpell("Guardian of Ancient Kings") && !SpellManager.Spells["Guardian of Ancient Kings"].Cooldown,
                            new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                            {
        ...
        {
            return (
                new Decorator(ret => (SpellManager.HasSpell("Judgement") && !SpellManager.Spells["Judgement"].Cooldown && (!GotBuff("Judgements of the Pure") || Me.ManaPercent < _mana_judge) && unitcheck(Enemy) && Enemy.Distance < Global_Judgment_range && Enemy.InLineOfSight) && !GotBuff("Hand of Protection"),
            new Wait(2,ret=> !IsCastingOrGCD(), 
                new Action(delegate
            {
...
return (
                new PrioritySelector(/*
                    ...
                    Composite_Trinkets(),
                        ...
                        new Decorator(ret => _wanna_DP && Me.HealthPercent < _min_DP_hp && Me.Combat && SpellManager.HasSpell("Divine Protection") && !SpellManager.Spells["Divine Protection"].Cooldown,
                            new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                            {
                        ...
                        new Decorator(ret => (_wanna_DS && !Me.HasAura("Alliance Flag") && !Me.HasAura("Horde Flag") && Me.HealthPercent < _min_DS_hp && !GotBuff("Forbearance") && Me.Combat && SpellManager.HasSpell("Divine Shield") && !SpellManager.Spells["Divine Shield"].Cooldown || ((GotBuff("Blind") || Me.Stunned || GotBuff("Polymorph")) && unitcheck(tar) && tar.HealthPercent < _min_DS_hp)),
                            new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                            {
            ...
            return (
                new PrioritySelector(/*
                    ...
                    Composite_Trinkets(),
                        ...
                        new Decorator(ret => (_wanna_DS && Me.HealthPercent < _min_DS_hp && !GotBuff("Forbearance") && Me.Combat && SpellManager.HasSpell("Divine Shield") && !SpellManager.Spells["Divine Shield"].Cooldown || ((GotBuff("Blind") || Me.Stunned || GotBuff("Polymorph")) && unitcheck(tar) && tar.HealthPercent < _min_DS_hp)),
                            new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                            {
                                if (Cast("Divine Shield", "Self", "Low HP"))
        ...
        public Composite Composite_tier_bonuses()
        {
            return (
                new PrioritySelector(
                    new Decorator(ret=>unitcheck(tar) &&SpellManager.HasSpell("Holy Shock") && !SpellManager.Spells["Holy Shock"].Cooldown && tar.Distance<40,//CanCast("Holy Shock", tar) /*&& !SpellManager.Spells["Holy Shock"].Cooldown*/,
                            new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                            {
                                if (Cast("Holy Shock", tar, 40, "Heal", "Healing"))
                            ...
                            new Decorator(ret=>!unitcheck(tar) && unitcheck(tank) &&SpellManager.HasSpell("Holy Shock") && !SpellManager.Spells["Holy Shock"].Cooldown && tank.Distance<40,//CanCast("Holy Shock", tar) /*&& !SpellManager.Spells["Holy Shock"].Cooldown*/,
                            new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                            {
                            ...
                            new Decorator(ret=>!unitcheck(tar) && !unitcheck(tank) && unitcheck(Me) &&SpellManager.HasSpell("Holy Shock") && !SpellManager.Spells["Holy Shock"].Cooldown,//CanCast("Holy Shock", tar) /*&& !SpellManager.Spells["Holy Shock"].Cooldown*/,
                            new Wait(2,ret=> !IsCastingOrGCD(), 
                                new Action(delegate
                            {
                ...
                new PrioritySelector(
                    new Decorator(ret => unitcheck(Me) && unitcheck(tank) && tank.Mounted && !Me.Mounted && !Me.Combat && !tank.Combat && Me != tank && Mount.CanMount(),
                        new Action(delegate
                        {
                            ...
                            Mount.MountUp();
                            new Wait(2, ret => Me.Mounted, new Action());
        ...
        public Composite Composite_print_tar()
        {
            ...
            {/*
                ...
                new Wait(2, ret => false,new Action());
              * */
        ...
        public Composite Composite_Wait()
        {
            return (
                new PrioritySelector(
                    ...
                    new Wait(2, ret=> ((!SpellManager.GlobalCooldown && !Me.IsCasting) || (SpellManager.GlobalCooldown && SpellManager.GlobalCooldownLeft.TotalMilliseconds<_how_much_wait) || (Me.IsCasting && Me.CurrentCastTimeLeft.TotalMilliseconds<_how_much_wait) || !IsCastingOrGCD()),
                        new Action(
                            delegate
                            {
                                return RunStatus.Failure;
            ...
            new Wait(2, ret => ((!SpellManager.GlobalCooldown && !Me.IsCasting) || !IsCastingOrGCD()),
                    new Action(
                        delegate
                        {
                            return RunStatus.Failure;
