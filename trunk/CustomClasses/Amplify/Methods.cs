...
!Styx.Logic.Blacklist.Contains(unit.Guid));
        ...
        public void pltthhing()
        {
            if (Me.BagItems.FirstOrDefault(o => o.Name == "Lifegiving Seed") != null && Me.BagItems.FirstOrDefault(o => o.Name == "Lifegiving Seed").StackCount > 0)
            {
                Me.BagItems.FirstOrDefault(o => o.Name == "Hearthstone").Use();
...
unit.Auras.ContainsKey("Polymorph"));
        ...
        {
            if (!SpellManager.HasSpell("Blink"))
            {
                Log("I dont know blink yet! BackPeddling!");
                BackPeddle();
            }
            else
            {
