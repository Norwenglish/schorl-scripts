...
namespace Bobby53
{
    ...
    public class ConfigValues
    {
        ...
        public enum SpellInterruptStyle { None, CurrentTarget, FocusTarget, All };
        ...
        public enum When { Never, Always, Auto };
        ...
        public When UseRaidBehavior = When.Auto;
        ...
        public int InstantHealPercent = 70;
        ...
        public bool RemoveOutOfRangeTotems = true;
        public bool UseGroundingTotemOnCooldown = false;

        public When DisableMovement = When.Auto;
        ...
        public int PVE_StressfulMobCount = 3;
        ...
        public bool PVP_UsePVPTrinket = true;
        public bool PVP_UseCooldowns = true;
        ...
        public ConfigHeal Raid_Heal;
        public int Raid_FollowAtRange = 25;
        ...
        public ConfigHeal Party_Heal;
        public int Party_FollowAtRange = 25;

        public int TC_StopCastAtHealth = 80;
        public int TC_CastIfManaBelow  = 15;
        public int TC_CastUnlessHealthBelow = 40;

        public RaidHealStyle Raid_HealStyle = RaidHealStyle.Auto;

        public const int EmergencySavingHealPct = 40;

        public bool RAF_UseCooldowns = true;
        ...
        public void DebugDump()
        {
            ...
            Logging.WriteDebug("  # InstantHealPercent:     '{0}'", this.InstantHealPercent );
            ...
            Logging.WriteDebug("  # WaterBreathing:         '{0}'", this.WaterBreathing);
            Logging.WriteDebug("  # UseGroundingTotemOnCD   '{0}'", this.UseGroundingTotemOnCooldown);
            ...
            Logging.WriteDebug("  # PVP_BloodlustCount      '{0}'", this.PVP_BloodlustCount);
            ...
            Logging.WriteDebug("  # PVP_Heal.SpiritLink     '{0}'", this.PVP_Heal.SpiritLink);
            Logging.WriteDebug("  # PVP_Heal.OhShoot        '{0}'", this.PVP_Heal.OhShoot);
            Logging.WriteDebug("  # PVP_Heal.GiftoftheNaaru '{0}'", this.PVP_Heal.GiftoftheNaaru);
            ...
            Logging.WriteDebug("  # PVP_Heal.ChainHealTgts  '{0}'", this.PVP_Heal.ChainHealTargets );
            Logging.WriteDebug("  # PVP_Heal.HealngRainTgts '{0}'", this.PVP_Heal.HealingRainTargets );
            Logging.WriteDebug("  # PVP_Heal.SpiritLinkTgts '{0}'", this.PVP_Heal.SpiritLinkTargets);

            // RAF
            Logging.WriteDebug("  #-- RAF SETTINGS ---------#");
            Logging.WriteDebug("  # RAF_CombatStyle:        '{0}'", this.RAF_CombatStyle);
            Logging.WriteDebug("  # RAF_GroupNeedHeal:      '{0}'", this.Party_Heal.MaxHealth );
            ...
            Logging.WriteDebug("  # RAF_UseCooldowns        '{0}'", this.RAF_UseCooldowns);

            Logging.WriteDebug("  # Party_Heal.HealingWave    '{0}'", this.Party_Heal.HealingWave);
            Logging.WriteDebug("  # Party_Heal.Riptide        '{0}'", this.Party_Heal.Riptide);
            Logging.WriteDebug("  # Party_Heal.ChainHeal      '{0}'", this.Party_Heal.ChainHeal);
            Logging.WriteDebug("  # Party_Heal.HealingRain    '{0}'", this.Party_Heal.HealingRain);
            Logging.WriteDebug("  # Party_Heal.UnleashElement '{0}'", this.Party_Heal.UnleashElements);
            Logging.WriteDebug("  # Party_Heal.HealingSurge   '{0}'", this.Party_Heal.HealingSurge);
            Logging.WriteDebug("  # Party_Heal.GreaterHW      '{0}'", this.Party_Heal.GreaterHealingWave);
            Logging.WriteDebug("  # Party_Heal.SpiritLink     '{0}'", this.Party_Heal.SpiritLink);
            Logging.WriteDebug("  # Party_Heal.OhShoot        '{0}'", this.Party_Heal.OhShoot);
            Logging.WriteDebug("  # Party_Heal.GiftoftheNaaru '{0}'", this.Party_Heal.GiftoftheNaaru);
            Logging.WriteDebug("  # Party_Heal.TidalWaves     '{0}'", this.Party_Heal.TidalWaves);
            Logging.WriteDebug("  # Party_Heal.Cleanse        '{0}'", this.Party_Heal.Cleanse);
            Logging.WriteDebug("  # Party_Heal.Pets           '{0}'", this.Party_Heal.Pets);
            Logging.WriteDebug("  # Party_Heal.SearchRange    '{0}'", this.Party_Heal.SearchRange);
            Logging.WriteDebug("  # Party_FollowAtRange       '{0}'", this.Party_FollowAtRange);
            Logging.WriteDebug("  # Party_Heal.ChainHealTgts  '{0}'", this.Party_Heal.ChainHealTargets);
            Logging.WriteDebug("  # Party_Heal.HealngRainTgts '{0}'", this.Party_Heal.HealingRainTargets);
            Logging.WriteDebug("  # Party_Heal.SpiritLinkTgts '{0}'", this.Party_Heal.SpiritLinkTargets);

            Logging.WriteDebug("  # Raid_HealStyle           '{0}'", this.Raid_HealStyle);
            Logging.WriteDebug("  # Raid_Heal.HealingWave    '{0}'", this.Raid_Heal.HealingWave);
            Logging.WriteDebug("  # Raid_Heal.Riptide        '{0}'", this.Raid_Heal.Riptide);
            Logging.WriteDebug("  # Raid_Heal.ChainHeal      '{0}'", this.Raid_Heal.ChainHeal);
            Logging.WriteDebug("  # Raid_Heal.HealingRain    '{0}'", this.Raid_Heal.HealingRain);
            Logging.WriteDebug("  # Raid_Heal.UnleashElement '{0}'", this.Raid_Heal.UnleashElements);
            Logging.WriteDebug("  # Raid_Heal.HealingSurge   '{0}'", this.Raid_Heal.HealingSurge);
            Logging.WriteDebug("  # Raid_Heal.GreaterHW      '{0}'", this.Raid_Heal.GreaterHealingWave);
            Logging.WriteDebug("  # Raid_Heal.SpiritLink     '{0}'", this.Raid_Heal.SpiritLink);
            Logging.WriteDebug("  # Raid_Heal.OhShoot        '{0}'", this.Raid_Heal.OhShoot);
            Logging.WriteDebug("  # Raid_Heal.GiftoftheNaaru '{0}'", this.Raid_Heal.GiftoftheNaaru);
            Logging.WriteDebug("  # Raid_Heal.TidalWaves     '{0}'", this.Raid_Heal.TidalWaves);
            Logging.WriteDebug("  # Raid_Heal.Cleanse        '{0}'", this.Raid_Heal.Cleanse);
            Logging.WriteDebug("  # Raid_Heal.Pets           '{0}'", this.Raid_Heal.Pets);
            Logging.WriteDebug("  # Raid_Heal.SearchRange    '{0}'", this.Raid_Heal.SearchRange);
            Logging.WriteDebug("  # Raid_FollowAtRange       '{0}'", this.Raid_FollowAtRange);
            Logging.WriteDebug("  # Raid_Heal.ChainHealTgts  '{0}'", this.Raid_Heal.ChainHealTargets);
            Logging.WriteDebug("  # Raid_Heal.HealngRainTgts '{0}'", this.Raid_Heal.HealingRainTargets);
            Logging.WriteDebug("  # Raid_Heal.SpiritLinkTgts '{0}'", this.Raid_Heal.SpiritLinkTargets );

            Logging.WriteDebug("  # TC_StopCastAtHealth       '{0}'", this.TC_StopCastAtHealth);
            Logging.WriteDebug("  # TC_CastIfManaBelow        '{0}'", this.TC_CastIfManaBelow);
            Logging.WriteDebug("  # TC_CastUnlessHealthBelow  '{0}'", this.TC_CastUnlessHealthBelow);
        ...
        public ConfigValues()
        {
            ...
            PVP_Heal.ChainHealTargets = 2;
            PVP_Heal.HealingRainTargets = 2;
            PVP_Heal.SpiritLinkTargets = 1;

            Party_Heal = new ConfigHeal();
            Party_Heal.HealingWave = 90;
            Party_Heal.Riptide = 0;
            Party_Heal.ChainHeal = 89;
            Party_Heal.HealingRain = 0;
            Party_Heal.GreaterHealingWave = 70;
            Party_Heal.UnleashElements = 69;
            Party_Heal.HealingSurge = 45;
            Party_Heal.OhShoot = 30;
            Party_Heal.SpiritLink = 44;
            Party_Heal.GiftoftheNaaru = 88;

            Party_Heal.TidalWaves = true;
            Party_Heal.Cleanse = true;
            Party_Heal.Pets = true;
            Party_Heal.SearchRange = 75;

            Party_Heal.ChainHealTargets = 2;
            Party_Heal.HealingRainTargets = 4;
            Party_Heal.SpiritLinkTargets = 1;

            Raid_Heal = new ConfigHeal();
            Raid_Heal.HealingWave = 95;
            Raid_Heal.Riptide = 0;
            Raid_Heal.ChainHeal = 94;
            Raid_Heal.HealingRain = 93;
            Raid_Heal.GreaterHealingWave = 20;
            Raid_Heal.UnleashElements = 19;
            Raid_Heal.SpiritLink = 18;
            Raid_Heal.HealingSurge = 10;
            Raid_Heal.OhShoot = 9;
            Raid_Heal.GiftoftheNaaru = 0;
            Raid_Heal.TidalWaves = false;
            Raid_Heal.Cleanse = false;
            Raid_Heal.Pets = true;

            Raid_Heal.ChainHealTargets = 2;
            Raid_Heal.HealingRainTargets = 4;
            Raid_Heal.SpiritLinkTargets = 2;
        }
        ...
        public bool FileLoad(string sFilename, out bool didUpgrade )
        {
            ...
            foreach (XElement elem in elements)
            {
                switch (elem.Name.ToString())
                {
                    ...
                    case "RaidBehavior":
                        LoadWhenType(elem, ref UseRaidBehavior);                          break;
                    ...
                    // OLD NAME for compatability
                    case "needlifeblood":
                        LoadInt(elem, ref InstantHealPercent); break;
                    // NEW NAME
                    case "needinstantheal":
                        LoadInt(elem, ref InstantHealPercent); break;
                    ...
                    case "removeoutofrangetotems":
                        LoadBool(elem, ref RemoveOutOfRangeTotems); break;
                    case "usegroundingtotemoncd":
                        LoadBool(elem, ref UseGroundingTotemOnCooldown); break;

                    case "disablemovementtype":
                        LoadWhenType(elem, ref DisableMovement); break;
                    ...
                    case "waterbreathing":
                        LoadBool(elem, ref WaterBreathing); break;
                    case "accountforlag":
                        LoadBool(elem, ref AccountForLag ); break;
                    ...
                    case "pvp_usepvptrinket":
                        LoadBool(elem, ref PVP_UsePVPTrinket); break;
                    case "pvp_usecooldowns":
                        LoadBool(elem, ref PVP_UseCooldowns); break;
                    ...
                    case "pvp_heal_spiritlink":
                        LoadInt(elem, ref PVP_Heal.SpiritLink ); break;
                    case "pvp_heal_ohshoot":
                        LoadInt(elem, ref PVP_Heal.OhShoot); break;
                    case "pvp_heal_giftofthenaaru":
                        LoadInt(elem, ref PVP_Heal.GiftoftheNaaru ); break;
                    ...
                    case "pvp_heal_chainhealtargets":
                        LoadInt(elem, ref PVP_Heal.ChainHealTargets ); break;
                    case "pvp_heal_healingraintargets":
                        LoadInt(elem, ref PVP_Heal.HealingRainTargets ); break;
                    case "pvp_heal_spiritlinktargets":
                        LoadInt(elem, ref PVP_Heal.SpiritLinkTargets); break;
                    ...
                    case "raf_usecooldowns":
                        LoadBool(elem, ref RAF_UseCooldowns); break;
                    ...
                    case "party_heal_healingwave":
                        LoadInt(elem, ref Party_Heal.HealingWave); break;
                    case "party_heal_riptide":
                        LoadInt(elem, ref Party_Heal.Riptide); break;
                    case "party_heal_unleashelements":
                        LoadInt(elem, ref Party_Heal.UnleashElements); break;
                    case "party_heal_chainheal":
                        LoadInt(elem, ref Party_Heal.ChainHeal); break;
                    case "party_heal_healingrain":
                        LoadInt(elem, ref Party_Heal.HealingRain); break;
                    case "party_heal_greaterhealingwave":
                        LoadInt(elem, ref Party_Heal.GreaterHealingWave); break;
                    case "party_heal_healingsurge":
                        LoadInt(elem, ref Party_Heal.HealingSurge); break;
                    case "party_heal_spiritlink":
                        LoadInt(elem, ref Party_Heal.SpiritLink); break;
                    case "party_heal_ohshoot":
                        LoadInt(elem, ref Party_Heal.OhShoot); break;
                    case "party_heal_giftofthenaaru":
                        LoadInt(elem, ref Party_Heal.GiftoftheNaaru ); break;

                    case "party_heal_tidalwaves":
                        LoadBool(elem, ref Party_Heal.TidalWaves); break;
                    case "party_heal_cleanse":
                        LoadBool(elem, ref Party_Heal.Cleanse); break;
                    case "party_heal_pets":
                        LoadBool(elem, ref Party_Heal.Pets); break;
                    case "party_heal_searchrange":
                        LoadDouble(elem, ref Party_Heal.SearchRange); break;
                    case "party_followatrange":
                        LoadInt(elem, ref Party_FollowAtRange ); break;
                    case "party_heal_chainhealtargets":
                        LoadInt(elem, ref Party_Heal.ChainHealTargets); break;
                    case "party_heal_healingraintargets":
                        LoadInt(elem, ref Party_Heal.HealingRainTargets); break;
                    case "party_heal_spiritlinktargets":
                        LoadInt(elem, ref Party_Heal.SpiritLinkTargets); break;

                    case "tc_stopcastathealth":
                        LoadInt(elem, ref TC_StopCastAtHealth); break;
                    case "tc_castifmanabelow":
                        LoadInt(elem, ref TC_CastIfManaBelow); break;
                    case "tc_castunlesshealthbelow":
                        LoadInt(elem, ref TC_CastUnlessHealthBelow); break;

                    case "raid_heal_healingwave":
                        LoadInt(elem, ref Raid_Heal.HealingWave); break;
                    case "raid_heal_riptide":
                        LoadInt(elem, ref Raid_Heal.Riptide); break;
                    case "raid_heal_unleashelements":
                        LoadInt(elem, ref Raid_Heal.UnleashElements); break;
                    case "raid_heal_chainheal":
                        LoadInt(elem, ref Raid_Heal.ChainHeal); break;
                    case "raid_heal_healingrain":
                        LoadInt(elem, ref Raid_Heal.HealingRain); break;
                    case "raid_heal_greaterhealingwave":
                        LoadInt(elem, ref Raid_Heal.GreaterHealingWave); break;
                    case "raid_heal_healingsurge":
                        LoadInt(elem, ref Raid_Heal.HealingSurge); break;
                    case "raid_heal_spiritlink":
                        LoadInt(elem, ref Raid_Heal.SpiritLink); break;
                    case "raid_heal_ohshoot":
                        LoadInt(elem, ref Raid_Heal.OhShoot); break;
                    case "raid_heal_giftofthenaaru":
                        LoadInt(elem, ref Raid_Heal.GiftoftheNaaru); break;

                    case "raid_heal_tidalwaves":
                        LoadBool(elem, ref Raid_Heal.TidalWaves); break;
                    case "raid_heal_cleanse":
                        LoadBool(elem, ref Raid_Heal.Cleanse); break;
                    case "raid_heal_pets":
                        LoadBool(elem, ref Raid_Heal.Pets); break;
                    case "raid_heal_searchrange":
                        LoadDouble(elem, ref Raid_Heal.SearchRange); break;
                    case "raid_followatrange":
                        LoadInt(elem, ref Raid_FollowAtRange); break;
                    case "raid_heal_chainhealtargets":
                        LoadInt(elem, ref Raid_Heal.ChainHealTargets); break;
                    case "raid_heal_healingraintargets":
                        LoadInt(elem, ref Raid_Heal.HealingRainTargets); break;
                    case "raid_heal_spiritlinktargets":
                        LoadInt(elem, ref Raid_Heal.SpiritLinkTargets ); break;

                    case "raid_healstyle":
                        LoadHealStyle(elem, ref Raid_HealStyle); break;
            ...
            if ( String.Compare( CreatedByVersion, Shaman.Version) != 0)
            {
                ...
                if (string.Compare(CreatedByVersion, "4.2.05") < 0)
                {
                    ...
                    Shaman.Slog(Color.Orange, "ConfigUpgrade:  DetectImmunities forced to {0}", DetectImmunities);
/*
                    if (RAF_CombatStyle == RafCombatStyle.HealingOnly)
                    {
                        Shaman.Slog(Color.Orange, "ConfigUpgrade:  RAF_CombatStyle changed from {0} to {1}", RAF_CombatStyle , RafCombatStyle.Auto);
 ...
 */
                ...
                {
                    if (DisableMovement != When.Auto)
                    {
                        Shaman.Slog("");
                        DisableMovement = When.Auto;
                ...
                // UPGRADE TO 4.5.17
                if (string.Compare(CreatedByVersion, "4.5.17") < 0)
                {
                    Shaman.Slog(Color.Orange, "ConfigUpgrade:  Party and Raid heal spell %'s updated");
                }
        ...
        private static void LoadSpellInterruptStyle(XElement elem, ref SpellInterruptStyle value)
        {
            switch (elem.Value.ToUpper()[0])
            {
                ...
                case 'C':
                    ...
                    break;
                case 'F':
                    value = SpellInterruptStyle.FocusTarget;
                    break;
                case 'A':
        ...
        private static void LoadWhenType(XElement elem, ref When dmt)
        {
            try
            {
                dmt = (When)Enum.Parse(typeof(When), elem.Value);
            }
            catch
            {
            }
        ...
        private static void LoadHealStyle(XElement elem, ref RaidHealStyle style)
        {
            try
            {
                style = (RaidHealStyle)Enum.Parse(typeof(RaidHealStyle), elem.Value);
            }
            catch
            {
            }
        ...
        public void Save(string sFilename)
        {
            ...
            doc.Add( new XElement("ShamWOW",
                        ...
                        new XElement("RaidBehavior", UseRaidBehavior),
                        ...
                        new XElement("needinstantheal", InstantHealPercent),
                        ...
                        new XElement("removeoutofrangetotems", RemoveOutOfRangeTotems),
                        new XElement("usegroundingtotemoncd", UseGroundingTotemOnCooldown ),
                        ...
                        new XElement("waterbreathing", WaterBreathing),
                        new XElement("accountforlag", AccountForLag),
                        ...
                        new XElement("pvp_usepvptrinket", PVP_UsePVPTrinket),
                        new XElement("pvp_usecooldowns",PVP_UseCooldowns),
                        ...
                        new XElement("pvp_heal_spiritlink", PVP_Heal.SpiritLink ),
                        new XElement("pvp_heal_ohshoot", PVP_Heal.OhShoot),
                        new XElement("pvp_heal_giftofthenaaru", PVP_Heal.GiftoftheNaaru),
                        ...
                        new XElement("pvp_heal_chainhealtargets", PVP_Heal.ChainHealTargets ),
                        new XElement("pvp_heal_healingraintargets", PVP_Heal.HealingRainTargets ),
                        new XElement("pvp_heal_spiritlinktargets", PVP_Heal.SpiritLinkTargets),
                        ...
                        new XElement("raf_usecooldowns", RAF_UseCooldowns),
                        ...
                        new XElement( "party_heal_healingwave", Party_Heal.HealingWave ),
                        new XElement("party_heal_chainheal", Party_Heal.ChainHeal),
                        new XElement("party_heal_healingrain", Party_Heal.HealingRain),
                        new XElement("party_heal_riptide", Party_Heal.Riptide),
                        new XElement("party_heal_greaterhealingwave", Party_Heal.GreaterHealingWave),
                        new XElement("party_heal_spiritlink", Party_Heal.SpiritLink),
                        new XElement("party_heal_ohshoot", Party_Heal.OhShoot),
                        new XElement("party_heal_giftofthenaaru", Party_Heal.GiftoftheNaaru ),
                        new XElement("party_heal_healingsurge", Party_Heal.HealingSurge),
                        new XElement("party_heal_unleashelements", Party_Heal.UnleashElements),

                        new XElement("party_heal_tidalwaves", Party_Heal.TidalWaves),
                        new XElement("party_heal_cleanse", Party_Heal.Cleanse),
                        new XElement("party_heal_pets", Party_Heal.Pets),
                        new XElement("party_heal_searchrange", Party_Heal.SearchRange),
                        new XElement("party_followatrange", Party_FollowAtRange),
                        new XElement("party_heal_chainhealtargets", Party_Heal.ChainHealTargets),
                        new XElement("party_heal_healingraintargets", Party_Heal.HealingRainTargets),
                        new XElement("party_heal_spiritlinktargets", Party_Heal.SpiritLinkTargets),

                        new XElement("raid_heal_healingwave", Raid_Heal.HealingWave),
                        new XElement("raid_heal_chainheal", Raid_Heal.ChainHeal),
                        new XElement("raid_heal_healingrain", Raid_Heal.HealingRain),
                        new XElement("raid_heal_riptide", Raid_Heal.Riptide),
                        new XElement("raid_heal_greaterhealingwave", Raid_Heal.GreaterHealingWave),
                        new XElement("raid_heal_spiritlink", Raid_Heal.SpiritLink),
                        new XElement("raid_heal_ohshoot", Raid_Heal.OhShoot),
                        new XElement("raid_heal_giftofthenaaru", Raid_Heal.GiftoftheNaaru),
                        new XElement("raid_heal_healingsurge", Raid_Heal.HealingSurge),
                        new XElement("raid_heal_unleashelements", Raid_Heal.UnleashElements),

                        new XElement("raid_heal_tidalwaves", Raid_Heal.TidalWaves),
                        new XElement("raid_heal_cleanse", Raid_Heal.Cleanse),
                        new XElement("raid_heal_pets", Raid_Heal.Pets),
                        new XElement("raid_heal_searchrange", Raid_Heal.SearchRange),
                        new XElement("raid_followatrange", Raid_FollowAtRange),
                        new XElement("raid_heal_chainhealtargets", Raid_Heal.ChainHealTargets),
                        new XElement("raid_heal_healingraintargets", Raid_Heal.HealingRainTargets),
                        new XElement("raid_heal_spiritlinktargets", Raid_Heal.SpiritLinkTargets),

                        new XElement("raid_healstyle", Raid_HealStyle),

                        new XElement("tc_stopcastathealth", TC_StopCastAtHealth),
                        new XElement("tc_castifmanabelow", TC_CastIfManaBelow),
                        new XElement("tc_castunlesshealthbelow", TC_CastUnlessHealthBelow)
    ...
    public class ConfigHeal
    {
        ...
        public int SpiritLink = 0;
        public int OhShoot= 0;
        public int GiftoftheNaaru = 0;
        public bool TidalWaves = true;
        public bool Cleanse = true;
        public bool Pets = false;
        public double SearchRange = 50;
        public int ChainHealTargets = 3;
        public int HealingRainTargets = 4;
        public int SpiritLinkTargets = 2;
        public ConfigHeal()
        {
        }
        ...
        public int MaxHealth
        {
            get
            {
                ...
                maxVal = Math.Max(maxVal, GiftoftheNaaru);
                return maxVal;
            }
        }
    }
