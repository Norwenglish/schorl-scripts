...
namespace Bobby53
{
    ...
    public class ConfigValues
    {
        ...
        public RaidHealStyle RAF_RaidHealStyle = RaidHealStyle.Auto ;
        ...
        public void DebugDump()
        {
            ...
            Logging.WriteDebug("  # RAF_HealStyle           '{0}'", this.RAF_RaidHealStyle);
            ...
            Logging.WriteDebug("  # RAF_Heal.GiftoftheNaaru '{0}'", this.RAF_Heal.GiftoftheNaaru);
            ...
            Logging.WriteDebug("  # RAF_Heal.ChainHealTgts  '{0}'", this.RAF_Heal.ChainHealTargets);
            Logging.WriteDebug("  # RAF_Heal.HealngRainTgts '{0}'", this.RAF_Heal.HealingRainTargets);
        ...
        public bool FileLoad(string sFilename, out bool didUpgrade )
        {
            ...
            foreach (XElement elem in elements)
            {
                switch (elem.Name.ToString())
                {
                    ...
                    case "raf_heal_giftofthenaaru":
                        LoadInt(elem, ref RAF_Heal.GiftoftheNaaru ); break;
                    ...
                    case "raf_heal_chainhealtargets":
                        LoadInt(elem, ref RAF_Heal.ChainHealTargets); break;
                    case "raf_heal_healingraintargets":
                        LoadInt(elem, ref RAF_Heal.HealingRainTargets); break;

                    case "raf_healstyle":
                        LoadHealStyle(elem, ref RAF_RaidHealStyle); break;
 ...
 */
        ...
        public void Save(string sFilename)
        {
            ...
            doc.Add( new XElement("ShamWOW",
                        ...
                        new XElement("raf_heal_giftofthenaaru", RAF_Heal.GiftoftheNaaru ),
                        ...
                        new XElement("raf_heal_chainhealtargets", RAF_Heal.ChainHealTargets),
                        new XElement("raf_heal_healingraintargets", RAF_Heal.HealingRainTargets),

                        new XElement("raf_healstyle", RAF_RaidHealStyle )
                        )
                    );
