...
namespace HazzDruid
{
    public partial class HazzDruidConfig : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
			...
			checkBox5.Checked = HazzDruidSettings.Instance.UseNourish;
        ...
        {
            HazzDruidSettings.Instance.UseNourish = checkBox5.Checked;
        }
        ...
        {
            HazzDruidSettings.Instance.LifebloomPercent = trackBar10.Value;
        }
