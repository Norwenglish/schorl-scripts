...
namespace Hera
{
    public static class Settings
    {
        ...
        public static string ConfigFolder = @"CustomClasses\Fpsware Mage\Class Specific\Settings\";
        public static string ConfigFile = @"CustomClasses\Fpsware Mage\Class Specific\Settings\Settings.xml";
